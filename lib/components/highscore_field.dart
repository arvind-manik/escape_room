...
class HighscoreField extends GameTextField {
  HighscoreField(GameController controller) : super(controller);

  void update(double delta) {
    String highScore = this.controller.getHighScore().toString();
    if ((this.painter.text ?? '') != highScore) {
